#!/usr/bin/env python3
"""Publish Week 10 BGP student resource pages to Canvas."""
...
# Week 10 pages mapping
PAGES = {
    '40329289': {
        'title': 'Week 10 | Page 1 - BGP Fundamentals and Configuration',
        'html_file': 'C:\\Users\\cburk\\AppData\\Local\\Temp\\claude\\D--GitHub-Repos-Canvas-Course-Updater\\c0df45c2-8bef-44b9-b91f-8ccd2afa994e\\scratchpad\\week10_page1_expanded.html',
        'description': 'Border Gateway Protocol fundamentals, autonomous systems, eBGP/iBGP sessions, and basic BGP configuration'
    },
    '40329288': {
        'title': 'Week 10 | Page 2 - BGP Advanced Topics and Route Manipulation',
        'html_file': 'C:\\Users\\cburk\\AppData\\Local\\Temp\\claude\\D--GitHub-Repos-Canvas-Course-Updater\\c0df45c2-8bef-44b9-b91f-8ccd2afa994e\\scratchpad\\week10_page2_expanded.html',
        'description': 'Path attributes, route filtering, aggregation, redistribution, convergence optimization, and multi-ISP deployments'
    }
}
...
def main():
    ...
    print("=" * 60)
    print("Canvas Week 10 Student Resource Pages Publisher")
    print("=" * 60)
