...
- **Example:** Week 1 of BIT360 (IR Fundamentals) could span: (1) InfoSec Fundamentals & Risk Assessment, (2) Threat Modeling Hands-On, (3) SysInternals Tools Guide, (4) Lab Environment Setup.
- **Practical guidance is the goal.** Worked examples, "why this matters," and step-by-step procedures ensure students can learn independently and complete assignments.
...
- **Include worked examples, code snippets, or screenshots** — Don't just explain
- **Use "Pro tip" or "Common mistake" boxes** — Practical student guidance

---
### 1E. Common Mistakes / Pitfalls (Dark charcoal background) — OPTIONAL
```html
...
**Rules:**
- Dark charcoal background, teal border (same as instructor format)
- Use ❌ and ✓ symbols for clarity
- List 2-4 common pitfalls students encounter
...
| **Examples** | Industry case studies, current news | Worked examples, code snippets, screenshots |
| **Sections** | Learning Objectives, Teaching Points, Lecture Content, What's Current, Reference Links | Learning Objectives, Why This Matters, Core Concepts, Common Mistakes, Reference Links |
| **Length** | 2500-4000 words (comprehensive) | 1500-2500 words (focused) |
...
3. **Practical over comprehensive** — One topic done well beats many topics done poorly.
4. **Worked examples required** — Don't just explain; show concrete examples, code, screenshots.
5. **Assignment-aligned** — Content directly supports the week's assignment(s).
6. **Encouraging tone** — Assume some students are struggling; be supportive.
7. **No instructor context** — No "teaching notes," "common misconceptions," or "current industry trends." Save those for instructor lectures.
8. **Common mistakes included** — Students learn by understanding what NOT to do.

---
## Step 6 — Example: BIT320 Week 1 | Student Page 1 (CANONICAL)
See `Week 1 | Student Page 1 - Log File Fundamentals` in BIT320 Canvas course for the authoritative example of student resource page format.
